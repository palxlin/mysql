...
network_connection_pool *network_connection_pool_new(void) {
	...
	/*begin of add*/
	pool->backends_ac = g_hash_table_new_full(g_hash_table_string_hash, g_hash_table_string_equal, g_hash_table_string_free, g_queue_free_all);
	pool->backends_non_ac = g_hash_table_new_full(g_hash_table_string_hash, g_hash_table_string_equal, g_hash_table_string_free, g_queue_free_all);
	/*end of add*/
