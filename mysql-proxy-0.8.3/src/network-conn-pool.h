...
typedef struct {
	...
	/*begin of add*/
	GHashTable *backends_ac;      /** GHashTable<GString, GQueue<network_connection_pool_entry> with autocommit*/
	GHashTable *backends_non_ac;  /** GHashTable<GString, GQueue<network_connection_pool_entry> with non-autocommit*/
    
	guint total_idle_connection;
	/*end of add*/
